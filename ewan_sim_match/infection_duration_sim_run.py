...
def general_sim(sites=None):
    ...
    # Sweep Larval habitat multipliers
    builder.add_sweep_definition(partial(set_param, param='x_Temp_LH_values'),
                                 params.x_Temp_LH_values)
    ...
    task.reporters.add_reporter(patient_report)  # Add the reporter
