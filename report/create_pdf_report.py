    ...
    'Additional comparisons of reference data and matched simulations':
        {'Incidence by age':
             ['Below, the plots show the correlation between the simulation and reference incidence '
              ...
              [f'{plot_folder}/scatter_regression_incidence_age_correlation.png',
               f'{plot_folder}/scatter_regression_incidence_age_slope_correlation.png'],
         ...
         'Prevalence by age':
             [
                 ...
                 'in the next oldest age group (right plot).',
                 [f'{plot_folder}/scatter_regression_prevalence_age_correlation.png',
                  f'{plot_folder}/scatter_regression_prevalence_age_slope_correlation.png'],
